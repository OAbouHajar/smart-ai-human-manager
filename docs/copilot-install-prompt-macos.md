...
1. Verify that macOS, git, Node.js 22.13 or newer, and at least one supported AI agent (GitHub Copilot, Claude Code, Codex, Gemini, or Microsoft Scout) are installed.
