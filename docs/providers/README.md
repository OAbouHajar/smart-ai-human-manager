...
Smart Human-AI Manager detects supported AI CLIs during installation and adds only its own lifecycle hook entries. Existing provider settings are preserved.

| Provider | Setup | Usage | Wrap interaction |
|---|---|---|---|
| GitHub Copilot CLI | [Setup](github-copilot/setup.md) | [Usage](github-copilot/usage.md) | `/sham:wrap` and related commands |
